...
class AboutPage extends Component {
    render() {
       ...
       </div><div>Cheers</div><div>-Reb (no idea what I'm doing)</div>
       <br></br>
       <h3 style={{ textAlign: "center"}} >How'd ya make this?</h3>
       <hr></hr>
       Oh yes! You were wondering what this site is made with? ReactJS! I used uhh Bootstrap and Material-UI, and a whole lotta different libraries out there
