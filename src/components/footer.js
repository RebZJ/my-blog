  ...
  return (
    <Container style={styles.root} fluid>
      ...
      >
        ...
        >
          <span>Copyright(c) all rig...blah blah blah, it's all on my</span>{" "}
          <a style={{ color: "grey" }} href={"https://github.com/RebZJ"}>
            {" "}
            Github,
          </a>
          <span> feel free to use it however you want</span>
        </div>
      </Col>
    </Container>
  );
